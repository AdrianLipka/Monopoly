...
POSITION_PLAYER = (((1160, 1090), (980, 1150), (880, 1150), (780, 1150), (680, 1150), (580, 1150), (480, 1150),
                    ...
                    (50, 580), (50, 480), (50, 380), (50, 280), (50, 180), (30, 120), (220, 100), (320, 100),
                    (420, 100), (520, 100), (620, 100), (720, 100), (820, 100), (920, 100), (1020, 100), (1175, 30),
                    (1150, 220), (1150, 320), (1150, 420), (1150, 520), (1150, 620), (1150, 720), (1150, 820),
                    (1150, 920), (1150, 1020)),
...
class Player:
    ...
    def __init__(self, screen, number):
        ...
        pygame.draw.circle(self.screen, COLORS_OF_PLAYER[self.number], POSITION_PLAYER[self.number-1][self.position],
                           CIRCLE_RADIUS)
    ...
    def move(self, move_step):
        """Defining to what position player should move"""
...
class Dice:
    ...
    def rolling_in_prison(self):
        """Rolling in the prison method"""
        self.move_step1 = randint(1, 6)
        self.move_step2 = randint(1, 6)
        return bool(self.move_step2 == 6 and self.move_step1 == 6)

    def showing(self):
        """Showing the dice to the board screen"""
