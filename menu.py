        ...
        while True:
            ...
            for event in pygame.event.get():
                if (event.type == pygame.MOUSEBUTTONDOWN and quit_button.is_hover()) or event.type == pygame.QUIT:
                    return "EXIT"
                if event.type == pygame.MOUSEBUTTONDOWN and rules_button.is_hover():
                    return "RULES"
                if event.type == pygame.MOUSEBUTTONDOWN and play_button.is_hover():
                    return "PLAY"
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEBUTTONDOWN and back_button.is_hover():
                    return True
                if (event.type == pygame.MOUSEBUTTONDOWN and next_button.is_hover()
                        and rule_displayed < PAGES_WITH_INSTRUCTIONS):
                    rule_displayed += 1
